...
export function ChatPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Put message back if request fails
      setMessage(content)
    }
  }
    ...
    <div className="flex h-screen overflow-hidden bg-[#212121] text-[#ECECEC]">
      ...
      >
        ...
        <nav className="min-h-0 flex-1 overflow-y-auto px-3 pb-3">
          <p className="px-2 py-2 text-xs font-medium text-[#8E8E9E]">
            Chats
          </p>
        ...
        <div className="flex items-center justify-between gap-2 border-t border-[#2A2A2A] p-3">
          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            <span className="truncate text-[13px] text-[#C5C5D2]">
              {user?.email}
            </span>
          </div>
      ...
      <main className="flex min-h-0 flex-1 flex-col">
              ...
              <>
                ...
                {sendStatus === 'loading' && (
                  <div className="mb-6 flex justify-start">
                    <div className="flex items-center gap-2 text-[15px] text-[#8E8E9E]">
                      <span>Thinking</span>
        ...
        <div className="px-4 pb-4">
          ...
          <p className="mx-auto mt-2 max-w-3xl text-center text-xs text-[#8E8E9E]">
            ChatGPT clone can make mistakes. Check
            important info.
          </p>
        </div>
      </main>
